...
public class AccountController {
	...
	@PostMapping("/deposit")
	public AccountDetail depositMoney(@RequestBody AccountDetail accountDetail) throws InvalidFieldException {
		accountService.depositMoney(accountDetail);
		return accountDetail;
	}

	@PostMapping("/withdraw")
	public AccountDetail withdrawMoney(@RequestBody AccountDetail accountDetail) throws InvalidFieldException {
	...
	@ExceptionHandler
	public String handleException(InvalidFieldException exception) {
